...
class EngineConfig:
    ...
    min_order_lifetime_ms: int = 5000
    reprice_threshold_bps: float = 2.0
    hard_reprice_threshold_bps: float = 8.0
...
def plan_cycle(cycle: CycleInput, quote_config: QuoteConfig, risk_limits: RiskLimits, engine_config: EngineConfig = EngineConfig()) -> CycleDecision:
    ...
    plan = reconcile_orders(
        ...
        hard_reprice_threshold_bps=engine_config.hard_reprice_threshold_bps,
        quote_epoch=cycle.now_ms,
    )
